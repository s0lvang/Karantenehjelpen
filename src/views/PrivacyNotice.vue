<template>
  <section>
    ...
    Du har gjennom GDPR rettigheter til blant annet å søke innsyn i dine data,
    få dem endret eller slettet. Du kan selv slette brukeren din og alle
    relaterte data på
    <a href="https://karantenehjelpen.no/my-page">Min side</a>.
    <!-- TODO: Verifisere at disse dataene faktisk slettes hos tredjeparter -->
    Å endre telefonnummer kan også gjøres på den siden. Om du ønsker å endre
    andre data eller søke innsyn i dine data, send en e-post til
